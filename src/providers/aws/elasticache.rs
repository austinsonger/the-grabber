    ...
    async fn collect_rows(
        ...
        loop {
            ...
            for rg in resp.replication_groups() {
                ...
                let (engine, engine_version, az) =
                    if let Some(cluster_id) = rg.member_clusters().first() {
                        match self
                            .client
                            ...
                            .await
                        {
                            Ok(cr) => {
                                ...
                                (
                                    ...
                                    c.and_then(|c| c.preferred_availability_zone())
                                        .unwrap_or("")
                                        .to_string(),
                                )
                            }
        ...
        loop {
            ...
            let resp = req
                .send()
                .await
                .context("ElastiCache describe_cache_clusters")?;
            ...
            for cluster in resp.cache_clusters() {
                ...
                if seen_rg_members.contains_key(&cluster_id) {
                    continue;
                }
    ...
    async fn collect_rows(
        ...
        loop {
            ...
            for group in resp.global_replication_groups() {
                ...
                let arn =
                    format!("arn:aws:elasticache::{account_id}:globalreplicationgroup:{name}");
