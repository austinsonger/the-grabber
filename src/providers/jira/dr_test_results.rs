...
impl CsvCollector for JiraDrTestResultsCollector {
    fn name(&self) -> &str { "Jira DR Test Results" }
    fn filename_prefix(&self) -> &str { "Jira_DR_Test_Results" }
    fn headers(&self) -> &'static [&'static str] {
        &[
            "Ticket", "Summary", "Test Date", "RTO Target Hours",
            "RTO Actual Hours", "RPO Target Hours", "RPO Actual Hours",
            "Reviewer",
        ]
    }
